 ...
 */
export function conditionDirectiveDeal({ context, el, attrName, vAttrNames }) {
  // this.conditionDirectiveStack 条件指令栈的对象
  const config = new Map([
    ['v-if', ifConditionDirectiveDeal],
    ['v-else', elseConditionDirectiveDeal],
    ['v-else-if', ifConditionDirectiveDeal],
  ]);
}

function ifConditionDirectiveDeal() {

}

function elseConditionDirectiveDeal() {

}

function elseIfConditionDirectiveDeal() {
